...
function sanitizeSegment(seg) {
  // OpenAPI uses /users/{id}; Bluecat URI templating uses /users/${id}.
  // We translate {param} -> ${param} so:
  //   - the generated tree key matches Bluecat's hand-written convention
  //   - service.users['${id}'].GET({ params: { id: '42' } }) does substitution
